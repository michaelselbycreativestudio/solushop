                    ...
                    <div class="row">
                         ...
                         if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                if ($row["Transaction_Type"] == "Cr") {
                                    ...
                                    $NEGLTotalDebitToCash += $row["Transaction_Amount"];
                                }
                        ...
                        <section class="col-lg-7 connectedSortable">
                         <?php 
                                ...
                                $sql = "SELECT * FROM account_transactions, account_entities WHERE account_transactions.Transaction_Entity_ID = account_entities.Entity_ID and Transaction_Entity_ID='4' ORDER BY Transaction_ID DESC";
                                $result = $conn->query($sql);
                                if ($result->num_rows > 0) {
