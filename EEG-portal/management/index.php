        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <?php 
                    ...
                    //New Orders
                      $sql = "SELECT count(*) as count FROM orders where Order_State='2'";
                    ...
                    //Ongoing Orders
                      $sql = "SELECT count(*) as count FROM orders where Order_State='3' OR Order_State='4' ";
                      $result = $conn->query($sql);
                      if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            $OngoingOrders = $row["count"];
                            }
                        }

                    //Completed Orders
                      $sql = "SELECT count(*) as count FROM orders where Order_State='5'";
                      $result = $conn->query($sql);
                      if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                    ...
                    //Cancelled Orders
                      $sql = "SELECT count(*) as count FROM orders where Order_State='6'";
                      $result = $conn->query($sql);
                      if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
