            			...
            			<main id="main" class="site-main">
            					...
            					<div class="content-body">
            						<header class="entry-header">
            							<h1 class="entry-title" itemprop="name headline">
            								<a href="blog-single.html" rel="bookmark">Robot Wars &#8211; Post with Gallery</a>
            							</h1>

            							<div class="entry-meta">
            								<span class="cat-links">
            									<a href="blog-single.html" rel="category tag">Design</a>, <a href="blog-single.html" rel="category tag">Technology</a>
            								</span>
            				...
            				<article class="post format-gallery hentry">
            					...
            					<div class="content-body">
            						<header class="entry-header">
            							<h1 class="entry-title" itemprop="name headline">
            								<a href="blog-single.html" rel="bookmark">Robot Wars – Now Closed – Post with Audio</a>
            							</h1>

            							<div class="entry-meta">
            								<span class="cat-links">
            									<a href="#" rel="category tag">Design</a>, <a href="blog-single.html" rel="category tag">Technology</a>
            								</span>
            				...
            				<article class="post format-gallery hentry">
            					...
            					<div class="content-body">
            						<header class="entry-header">
            							<h1 class="entry-title" itemprop="name headline">
            								<a href="blog-single.html" rel="bookmark">Robot Wars – Now Closed – Post with Video</a>
            							</h1>
            				...
            				<article class="post format-gallery has-post-thumbnail hentry">
            					...
            					<div class="content-body">
            						<header class="entry-header">
            							<h1 class="entry-title" itemprop="name headline">
            								<a href="blog-single.html" rel="bookmark">Announcement – Post without Image</a>
            							</h1>
