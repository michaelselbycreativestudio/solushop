...
//            "proxy_port" => 8888,
     ...
     * @return mixed
     */
    function ProcessPaymentOrder($order_id, $sub_total, $shipping_cost, $tax_amount, $total, $comment1, $comment2,array $order_item) {
        try {
            $params = array(
                'orderId' =>  $order_id[0],
                'subtotal' => $sub_total,
        ...
        // var_dump($params);
         //exit();
            //$return = $this->slyde->ProcessPaymentOrder($order_id, $sub_total, $shipping_cost, $tax_amount, $total, $comment1, $comment2, $order_item);
