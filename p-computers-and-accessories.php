        ...
        <div id="page" class="hfeed site">
            ...
            <div id="content" class="site-content" tabindex="-1">
            	<div class="container">
            		...
            		<nav class="woocommerce-breadcrumb" ><a href="home.html">Home</a><span class="delimiter"><i class="fa fa-angle-right"></i></span>Computers &amp; Accessories</nav>

            		<div id="primary" class="content-area">
            			<main id="main" class="site-main">
                			<section>
                                <header>
                                    <h2 class="h1">Computers &amp; Accessories</h2>
                                </header>
                                <div class="woocommerce columns-4">
                                    <ul class="product-loop-categories">
                                        <li class="product-category product first"><a href="product-category-redirect.php?cat=sub||1.2"><img src="assets/images/product-category/h.png" alt="Accessories" width="250" height="232" /><h3>Laptops <mark class="count">(2)</mark></h3></a></li>
                                        <li class="product-category product"><a href="product-category-redirect.php?cat=sub||1.1"><img src="assets/images/product-category/i.png" alt="Desktops" width="250" height="232" /><h3>Desktops<mark class="count">(1)</mark></h3></a></li>
                                        <li class="product-category product"><a href="product-category-redirect.php?cat=sub||1.3"><img src="assets/images/product-category/j.png" alt="Bags and Chargers" width="250" height="232" /><h3>Bags and Chargers <mark class="count">(1)</mark></h3></a></li>
                                        <li class="product-category product last"><a href="product-category-redirect.php?cat=sub||1.4"><img src="assets/images/product-category/k.png" alt="Accessories" width="250" height="232" /><h3>Accessories <mark class="count">(6)</mark></h3></a></li>
