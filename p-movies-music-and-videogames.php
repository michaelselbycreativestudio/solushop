...
<script>
  ...
  gtag('config', 'UA-71743571-3');
        ...
        <title>Movies, Music &amp; Video Games</title>
        ...
        <div id="page" class="hfeed site">
            ...
            <div id="content" class="site-content" tabindex="-1">
            	<div class="container">
            		...
            		<nav class="woocommerce-breadcrumb" ><a href="home.html">Home</a><span class="delimiter"><i class="fa fa-angle-right"></i></span>Movies, Music &amp; Video Games</nav>

            		<div id="primary" class="content-area">
            			<main id="main" class="site-main">
                			<section>
                                <header>
                                    <h2 class="h1">Movies, Music &amp; Video Games</h2>
                                </header>
                                <div class="woocommerce columns-4">
                                    <ul class="product-loop-categories">
                                        <li class="product-category product first"><a href="product-category-redirect.php?cat=sub||4.1"><img src="assets/images/product-category/consoles-min.png" alt="Consoles" width="250" height="232" /><h3>Consoles <mark class="count">(2)</mark></h3></a></li>
                                        <li class="product-category product"><a href="product-category-redirect.php?cat=sub||4.2"><img src="assets/images/product-category/games-min.png" alt="Games" width="250" height="232" /><h3>Games <mark class="count">(1)</mark></h3></a></li>
                                        <li class="product-category product"><a href="product-category-redirect.php?cat=sub||4.3"><img src="assets/images/product-category/gaming-accessories-min.png" alt="Accessories" width="250" height="232" /><h3>Accessories <mark class="count">(1)</mark></h3></a></li>
                                    </ul>
                                </div>
                            </section>
