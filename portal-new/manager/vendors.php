...
<head>
  ...
  <title>Solushop - Manage Vendors</title>
      ...
      <div class="main-menu menu-static menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
          <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item active"><a href=""><i class="la la-link"></i><span class="menu-title" data-i18n="nav.dash.main">Vendors</span></a>
              <ul class="menu-content">
              ...
              <div class="card">
                <?php 
                    try{
                        ...
                        $supplier_select_query = "SELECT * FROM suppliers";
                        $stmt = $db->prepare($supplier_select_query);
                        $stmt->execute();
                        $supplier_select_query_result = $stmt->fetchAll(PDO::FETCH_OBJ);
                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    <table class="table table-striped table-bordered zero-configuration">
                      ...
                      <tbody>
                        <?php 
                            for($i=0; $i<sizeof($supplier_select_query_result); $i++) {
                                echo "
                                    <tr>
                                    <td>".$supplier_select_query_result[$i]->ID."</td>
                                    <td>".$supplier_select_query_result[$i]->Username."</td>
                                    <td>".$supplier_select_query_result[$i]->Name."</td>
                                    <td>".$supplier_select_query_result[$i]->Email."</td>
                                    <td>".$supplier_select_query_result[$i]->Phone."</td>
                                    <td>".$supplier_select_query_result[$i]->AltPhone."</td>
                                    <td><a href='viewvendor.php?id=".$supplier_select_query_result[$i]->ID."'><button class='btn btn-sm btn-info box-shadow-2 round btn-min-width center'>View Details</button></a></td>
                                    </tr>
                                    ";
                            }
                        ?>
