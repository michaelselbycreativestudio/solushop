                        ...
                        <div class="card-body">
                            <form class="form" method="POST" action="#">
                                <div class="form-body">
                                    ...
                                    <input id="CustomerNameInput" name="Customer_Name" class="form-control round" placeholder="company name" value="<?php echo $Supplier_Name; ?>" name="companyname" type="text">
                                    </div>
                                    <div class="form-group">
                                    <label for="CustomerEmailInput">Vendor Username</label>
                                    <input id="CustomerEmailInput" name="Customer_Email"  class="form-control round" placeholder="company name" value="<?php echo $Supplier_Username; ?>" name="companyname" type="text" disabled> 
                                    </div>
                                    <div class="form-group">
                                    <label for="CustomerEmailInput">Vendor Email</label>
                                    <input id="CustomerEmailInput" name="Customer_Email"  class="form-control round" placeholder="company name" value="<?php echo $Supplier_Email; ?>" name="companyname" type="text">
                                    </div>
                                    <div class="form-group">
                                    <label for="CustomerPhoneInput">Vendor Phone Number</label>
                                    <input id="CustomerPhoneInput" name="Customer_Phone"  class="form-control round" placeholder="company name" value="<?php echo $Supplier_Phone; ?>" name="companyname" type="text">
                                    </div>
                                    <div class="form-group">
                                    <label for="CustomerPhoneInput">Vendor Alt. Phone Number</label>
                                    <input id="CustomerPhoneInput" name="Customer_Phone"  class="form-control round" placeholder="company name" value="<?php echo $Supplier_Alt_Phone; ?>" name="companyname" type="text">
                                    </div>
                                    <div class="form-group">
                                    <label for="CustomerNameInput">Vendor Address</label>
                                    <input id="CustomerNameInput" name="Customer_Name" class="form-control round" placeholder="company name" value="<?php echo $Supplier_Address; ?>" name="companyname" type="text">
                                    </div>
                                </div>
