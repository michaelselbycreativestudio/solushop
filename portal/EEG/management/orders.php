                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                   ...
                                   <div class="box-tools">
                                    ...
                                    <?php 
                                        ...
                                        if (isset($_POST['submit_table_search'])) {
                                             ...
                                             $TableSearch = htmlspecialchars($_POST["table_search"]);
                               ...
                               try{              
                                            ...
                                            $cus_order= "SELECT * FROM orders, customers where customers.Customer_ID = orders.Customer_ID and (FName LIKE '%$SearchValue%' OR LName LIKE '%$SearchValue%' OR Email LIKE '%$SearchValue%' OR EmailVerified LIKE '%$SearchValue%' OR Phone LIKE '%$SearchValue%' OR PhoneVerified LIKE '%$SearchValue%' OR ActivationCode LIKE '%$SearchValue%')";
                                        }else{
                                        $cus_order = "SELECT * FROM orders, customers, order_state where customers.Customer_ID = orders.Customer_ID and orders.Order_State = order_state.ID";
                                        }
                                            ...
                                            echo '{"error": {"text": '.$e->getMessage().'}';}
                                              ...
                                              if (sizeof($cus_order_result)>0) {
                                                ...
                                                for($i=0; $i<sizeof($cus_order_result); $i++) {
                                                    echo 
                                                    "<tr>
                                                                <td>".$cus_order_result[$i]->Order_ID."</td>
                                                                <td>".$cus_order_result[$i]->FName." ".$cus_order_result[$i]->LName."</td>
                                                                <td>".$cus_order_result[$i]->Email."</td>
                                                                <td>".$cus_order_result[$i]->Phone."</td>
                                                                <td><a href='vieworderdetails.php?id=".$cus_order_result[$i]->Order_ID."'><button class='btn btn-success btn-sm'>View Details</button></a></td>
                                                            </tr>";
                                                    }
                                                }
