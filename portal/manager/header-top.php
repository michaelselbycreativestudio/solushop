<?php 
  ...
  try{
    $db = new db();
    $db = $db->connect();
    $solushop_manager_query = "SELECT * from manager WHERE ID = '$Solushop_Manager_ID'";
    $stmt = $db->prepare($solushop_manager_query);
    $stmt->execute();
    $solushop_manager = $stmt->fetchAll(PDO::FETCH_OBJ);
    $db = null;
            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                ...
                <span class="avatar avatar-online">
                  <img src="../app-assets/images/avi/<?php echo $solushop_manager[0]->Avi;  ?>" alt="avatar"><i></i></span>
              </a>
