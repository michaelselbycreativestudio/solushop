...
<?php 
    ...
    if (isset($_POST["AddComputer"])) {
        ...
        */
        ...
        }elseif(StringValidation($ScreenSize, "Computer Screen Size") != "good"){
            $UploadProductError = StringValidation($ScreenSize, "Computer Screen Size");
        }elseif(StringValidation($OS, "Pre-Installed Operating System") != "good"){
            $UploadProductError = StringValidation($OS, "Pre-Installed Operating System");
        }elseif(StringValidation($RAM, "RAM Value") != "good"){
            $UploadProductError =StringValidation($RAM, "RAM Value");
        }elseif(StringValidation($ProcessorType, "Processor Type") != "good"){
            $UploadProductError = StringValidation($ProcessorType, "Processor Type");
        }elseif(StringValidation($ProcessorSpeed, "Processor Speed") != "good"){
            $UploadProductError = StringValidation($ProcessorSpeed, "Processor Speed");
        }elseif(StringValidation($DisplayPort, "Display Port") != "good"){
            $UploadProductError = StringValidation($DisplayPort, "Display Port");
        }elseif(StringValidation($Generation, "Processor Generation") != "good"){
            $UploadProductError = StringValidation($Generation, "Processor Generation");
        }elseif(StringValidation($HardDiskType, "Hard Disk Type") != "good"){
            $UploadProductError = StringValidation($HardDiskType, "Hard Disk Type");
        }elseif(StringValidation($HardDiskSize, "Hard Disk Size") != "good"){
            $UploadProductError = StringValidation($HardDiskSize, "Hard Disk Size");
        }elseif(StringValidation($BatteryLifeSpan, "Battery Life Span") != "good"){
            $UploadProductError = StringValidation($BatteryLifeSpan, "Battery Life Span");
        }
        ...
        if (!isset($UploadProductError)) {
            ...
            try{
                ...
                //inserting into computer specifications table
                try{
                    $insert_pc_spec = "INSERT INTO `computer_specifications` (`Product_ID`, `ScreenSize`, `OS`, `RAM`, `ProcessorType`, `ProcessorSpeed`, `DisplayPort`, `Generation`, `HardDiskType`, `HardDiskSize`, `BatteryLifeSpan`) VALUES (:ProductID,  :ScreenSize, :OS, :RAM, :ProcessorType, :ProcessorSpeed, :DisplayPort, :Generation, :HardDiskType, ':HardDiskSize, :BatteryLifeSpan)";
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Manager | Add Computer</title>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Add Computer (Laptop Or Desktop)
                    </h1>
                    <ol class="breadcrumb">
                    ...
                    <div class="row">
                        ...
                        elseif (isset($UploadProductSuccess)) {
                            ...
                            if (!isset($ScreenSize)) {
                             ...
                             if (!isset($ProcessorType)) {
                               $ProcessorType = "";
                            }
                             if (!isset($ProcessorSpeed)) {
                               $ProcessorSpeed = "";
                            }
                             if (!isset($DisplayPort)) {
                               $DisplayPort = "";
                            }
                             if (!isset($Generation)) {
                               $Generation = "";
                            }
                             if (!isset($HardDiskType)) {
                               $HardDiskType = "";
                            }
                             if (!isset($HardDiskSize)) {
                               $HardDiskSize = "";
                            }
                             if (!isset($BatteryLifeSpan)) {
                               $BatteryLifeSpan = "";
                            }
                                    ...
                                    <div class=\"box-body no-padding\">
                                        ...
                                        <table class=\"table table-condensed\">
                                            ...
                                            <tr>
                                                ...
                                                <td><input placeholder='MacBookPro 2016' class=\"form-control input-sm\" name = 'DisplayLine' type=\"text\" value=\"$DisplayLine\"></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input placeholder='Sleek and beautiful' name = 'IntroductoryLine' class=\"form-control input-sm\" type=\"text\" value=\"$IntroductoryLine\"></td>
                                            </tr>
                                            <tr>
                                                <td width=\"30%\">Highlighted Features</td>
                                                <td><input placeholder='Fast, 4K Retina, Solid State Drive, Windows Compatible' name = 'HighlightedFeatures' class=\"form-control input-sm\" type=\"text\" value=\"$HighlightedFeatures\"></td>
                                            </tr>
                                            <tr>
                                                <td width=\"30%\">Description</td>
                                                <td><input placeholder='The Macbook pro 2016 is a good laptop for developers that want to keep on the move yet need high specs for working on the move.' name = 'Description' class=\"form-control input-sm\" type=\"text\" value=\"$Description\"></td>
                                            </tr>
                                            <tr>
                                                <td width=\"30%\">Tags</td>
                                                <td><input placeholder='Black, Camera' name = 'Tags' class=\"form-control input-sm\" type=\"text\" value=\"$Tags\"></td>
                                            </tr>
                            ...
                            echo "</br>";
                                ...
                                <div class=\"box box-solid box-info\" >
                                    <div class=\"box-header\">
                                        <h3 class=\"box-title\" style=\"text-align: center;\"> Computer Type</h3>
                                    </div><!-- /.box-header -->
                                    <div class=\"box-body no-padding\">
                                        ...
                                        <table class=\"table table-condensed\">
                                            ...
                                            <tr>
                                                <td width=\"30%\">Select Computer Type</td>
                                                <td><select name='Category' class=\"form-control\">
                                                        <option value='1.1'>Desktop</option>
                                                        <option value='1.2'>Laptop</option>
                                                    </select></td>
                                            </tr>
                           ...
                           //Technical specifications     
                            echo "
                                <div class=\"box box-solid box-info\" >
                                    <div class=\"box-header\">
                                        <h3 class=\"box-title\" style=\"text-align: center;\"> Technical Specifications</h3>
                                    </div><!-- /.box-header -->
                                    <div class=\"box-body no-padding\">
                                        ...
                                        <table class=\"table table-condensed\">
                                            ...
                                            <tr>
                                                ...
                                                <td><input placeholder='13.3 inch' name = 'ScreenSize' class=\"form-control input-sm\" type=\"text\" value=\"$ScreenSize\"></td>
                                            </tr>
                                            <tr>
                                                <td width=\"30%\">Pre-Installed Operating System</td>
                                                <td><input placeholder='Mac OS Sierra' name = 'OS' class=\"form-control input-sm\" type=\"text\" value=\"$OS\"></td>
                                            </tr>
                                            <tr>
                                                <td width=\"30%\">RAM</td>
                                                <td><input placeholder='4GB' name = 'RAM' class=\"form-control input-sm\" type=\"text\" value=\"$RAM\"></td>
                                            </tr>
                                            <tr>
                                                <td width=\"30%\">Processor Type</td>
                                                <td><input placeholder='dual-core Intel Core i5' name = 'ProcessorType' class=\"form-control input-sm\" type=\"text\" value=\"$ProcessorType\"></td>
                                            </tr>

                                            <tr>
                                                <td width=\"30%\">Processor Speed</td>
                                                <td><input placeholder='1.6GHz' name = 'ProcessorSpeed' class=\"form-control input-sm\" type=\"text\" value=\"$ProcessorSpeed\"></td>
                                            </tr>
                                            <tr>
                                                <td width=\"30%\">Display Port</td>
                                                <td><input placeholder='HDMI' name = 'DisplayPort' class=\"form-control input-sm\" type=\"text\" value=\"$DisplayPort\"></td>
                                            </tr>
                                            <tr>
                                                <td width=\"30%\">Generation</td>
                                                <td><input placeholder='5th' name = 'Generation' class=\"form-control input-sm\" type=\"text\" value=\"$Generation\"></td>
                                            </tr>
                                            <tr>
                                                <td width=\"30%\">Hard Disk Type</td>
                                                <td><input placeholder='Solid State Drive' name = 'HardDiskType' class=\"form-control input-sm\" type=\"text\" value=\"$HardDiskType\"></td>
                                            </tr>
                                            <tr>
                                                <td width=\"30%\">Hard Disk Size</td>
                                                <td><input placeholder='256GB' name = 'HardDiskSize' class=\"form-control input-sm\" type=\"text\" value=\"$HardDiskSize\"></td>
                                            </tr>
                                            <tr>
                                                <td width=\"30%\">Battery LifeSpan</td>
                                                <td><input placeholder='6-9 hours' name = 'BatteryLifeSpan' class=\"form-control input-sm\" type=\"text\" value=\"$BatteryLifeSpan\"></td>
                                            </tr>
                                        </table>
                                    </div><!-- /.box-body -->
                                </div><!-- /.box -->";
                                ...
                                <div class=\"box box-solid box-info\" >
                                    ...
                                    <div class=\"box-body no-padding\">
                                        ...
                                        <table class=\"table table-condensed\">
                                            ...
                                            try{
                                                $select_products = "SELECT * FROM `products` WHERE (Category = '1.3' OR Category = '1.4' OR Category = '2.2' OR Category = '4.3' OR Category = '6.1' OR Category = '6.2' OR Category = '6.3') AND  Stock > 0";
                        ...
                        <div style="text-align: center;" >
                            <input class='btn btn-success btn-lg' type="submit" name="AddComputer" value="Add Computer">
                        </div>
