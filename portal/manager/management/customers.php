                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive no-padding">
                                            ...
                                            <?php
                                              ...
                                              if (isset($_POST['submit_table_search'])) {
                                                  $num_orders = "SELECT count(*) as count  FROM customers LEFT JOIN customer_address ON customers.Customer_ID = customer_address.Customer_ID where Region LIKE '%$SearchValue%' OR Town LIKE '%$SearchValue%' OR Address LIKE '%$SearchValue%' OR FName LIKE '%$SearchValue%' OR LName LIKE '%$SearchValue%' OR Email LIKE '%$SearchValue%' OR EmailVerified LIKE '%$SearchValue%' OR Phone LIKE '%$SearchValue%' OR PhoneVerified LIKE '%$SearchValue%' OR ActivationCode LIKE '%$SearchValue%'";
                                              }else{
                                                    $num_orders ="SELECT count(*) as count FROM customers";
                                              }
                                            ...
                                            if (sizeof($num_order_Result)>0) {
                                             ...
                                             $left_rec = $rec_count - ($page * $rec_limit);
                                              if (isset($_POST['submit_table_search'])) {
                                                $cus_order = "SELECT *, customers.Customer_ID as CID FROM customers LEFT JOIN customer_address ON customers.Customer_ID = customer_address.Customer_ID where Region LIKE '%$SearchValue%' OR Town LIKE '%$SearchValue%' OR Address LIKE '%$SearchValue%' OR FName LIKE '%$SearchValue%' OR LName LIKE '%$SearchValue%' OR Email LIKE '%$SearchValue%' OR EmailVerified LIKE '%$SearchValue%' OR Phone LIKE '%$SearchValue%' OR PhoneVerified LIKE '%$SearchValue%' OR ActivationCode LIKE '%$SearchValue%' ";
                                            }else{
                                              ...
                                              for($i=0; $i<sizeof($cus_order_result); $i++) {
                                                ...
                                                echo 
                                                    "<tr>
                                                                ...
                                                                echo "<td><a href='viewcustomerdetails.php?id=".$cus_order_result[$i]->Customer_ID."'><button class='btn btn-info btn-sm'>View Details</button></a>&nbsp;&nbsp;</td>
                                                            </tr>";
