...
<html>
    <head>
        ...
        <!-- Daterange picker -->
        <link href="../../assets/management/css/daterangepicker/daterangep  icker-bs3.css" rel="stylesheet" type="text/css" />
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-aqua">
                                ...
                                <a href="orders.php?SelectedGrouping=NewOrders" class="small-box-footer">
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-yellow">
                                ...
                                <a href="orders.php?SelectedGrouping=OngoingOrders" class="small-box-footer">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-green">
                                ...
                                <a href="orders.php?SelectedGrouping=CompletedOrders" class="small-box-footer">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-red">
                                ...
                                <a href="orders.php?SelectedGrouping=CancelledOrders" class="small-box-footer">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
