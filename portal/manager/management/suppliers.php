                                ...
                                <div class="box-body table-responsive no-padding">
                                            ...
                                            <?php
                                              ...
                                              try{
                                                ...
                                                $db = $db->connect();
                                              if (isset($_POST['submit_table_search'])) {
                                                  $select_products = "SELECT count(*) as count  FROM customers LEFT JOIN customer_address ON customers.Customer_ID = customer_address.Customer_ID where Region LIKE '%$SearchValue%' OR Town LIKE '%$SearchValue%' OR Address LIKE '%$SearchValue%' OR FName LIKE '%$SearchValue%' OR LName LIKE '%$SearchValue%' OR Email LIKE '%$SearchValue%' OR EmailVerified LIKE '%$SearchValue%' OR Phone LIKE '%$SearchValue%' OR PhoneVerified LIKE '%$SearchValue%' OR ActivationCode LIKE '%$SearchValue%'";
                                                  $stmt = $db->prepare($select_products);
                                              }else{
                                                    $select_products="SELECT count(*) as count FROM suppliers";
                                                    $stmt = $db->prepare($select_products);
                                              }
                                              $stmt->execute();
                                          ...
                                          if (sizeof($product_result)>0) {
                                            for($i=0; $i<sizeof($product_result); $i++) {
                                                $rec_count = $product_result[$i]->count;
                                                }
                                            }
                                             ...
                                             try{
                                              if (isset($_POST['submit_table_search'])) {
                                                $search_sup = "SELECT *, customers.Customer_ID as CID FROM customers LEFT JOIN customer_address ON customers.Customer_ID = customer_address.Customer_ID where Region LIKE '%$SearchValue%' OR Town LIKE '%$SearchValue%' OR Address LIKE '%$SearchValue%' OR FName LIKE '%$SearchValue%' OR LName LIKE '%$SearchValue%' OR Email LIKE '%$SearchValue%' OR EmailVerified LIKE '%$SearchValue%' OR Phone LIKE '%$SearchValue%' OR PhoneVerified LIKE '%$SearchValue%' OR ActivationCode LIKE '%$SearchValue%' ";
                                                $stmt = $db->prepare($search_sup);
                                            }else{
                                             $search_sup = "SELECT * FROM suppliers";
                                             $stmt = $db->prepare($search_sup);
                                            }
                                            $stmt->execute();
                                            ...
                                            if (sizeof($search_result)>0) {
                                              ...
                                              for($i=0; $i<sizeof($search_result); $i++) {
                                                ...
                                                echo 
                                                    "<tr>
                                                                <td>".$search_result[$i]->ID."</td>
                                                                <td>".$search_result[$i]->Username."</td>
                                                                <td>".$search_result[$i]->Name."</td>
                                                                <td>".$search_result[$i]->Email."</td>
                                                                <td>".$search_result[$i]->Phone."</td>
                                                                <td>".$search_result[$i]->AltPhone."</td>
                                                                <td><a href='viewsupplierdetails.php?id=".$search_result[$i]->ID."'><button class='btn btn-success btn-sm'>View Details</button></a></td>
                                                            </tr>";
