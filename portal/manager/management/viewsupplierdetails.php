    ...
    if (isset($_POST["UpdateSupplierGeneralDetails"])) {
        ...
        if (!isset($ErrorMessage)) {
            ...
            try{
                ...
                $db = $db->connect();            
                $update_supplier = "UPDATE suppliers SET FName=:Supplier_First_Name, LName=:Supplier_Last_Name, Email=:Supplier_Email, EmailVerified=:Supplier_Email_Verified', Phone=:Supplier_Phone, PhoneVerified=:Supplier_Phone_Verified where Supplier_ID=:SID";
                $stmt = $db->prepare($update_supplier);
                $stmt->bindParam(':Supplier_First_Name',$Supplier_First_Name);
                $stmt->bindParam(':Supplier_Last_Name',$Supplier_Last_Name);
                $stmt->bindParam(':Supplier_Email',$Supplier_Email);
                $stmt->bindParam(':Supplier_Phone',$Supplier_Phone);
                $stmt->bindParam(':Supplier_Phone_Verified',$Supplier_Phone_Verified);
                $stmt->bindParam(':SID',$SID);
                $stmt->bindParam(':Supplier_Email_Verified',$Supplier_Email_Verified);
                if ($stmt->execute()) {
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Suppliers
                        <small>Edit Supplier's details</small>
                    </h1>
                    <ol class="breadcrumb">
                            ...
                            try{
                                ...
                                <div class=\"box box-solid box-info\" >
                                    <div class=\"box-header\">
                                        <h3 class=\"box-title\" style=\"text-align: center;\"> General Supplier Details</h3>
                                    </div><!-- /.box-header -->
                                    <div class=\"box-body no-padding\">
                                        ...
                                        <table class=\"table table-condensed\">
                                            <tr>
                                                <td width=\"30%\">ID</td>
                                                <td><input placeholder='' name = 'Supplier_ID' value='$SID' class=\"form-control input-sm\" type=\"text\" disabled></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <td width=\"30%\">Name</td>
                                                <td width=\"70%\"><input placeholder='' name = 'Supplier_Name' class=\"form-control input-sm\" type=\"text\" value=\"$Supplier_Name\"></td>
                                                <td></td>

                                            </tr>
                                            <tr>
                                                <td width=\"30%\">Username</td>
                                                <td width=\"70%\"><input placeholder='' name = 'Supplier_Username' class=\"form-control input-sm\" type=\"text\" value=\"$Supplier_Username \" disabled></td>
                                                <td></td>

                                            </tr>
                                            <tr>
                                                <td width=\"30%\">Email</td>
                                                <td><input placeholder='' name = 'Supplier_Email' class=\"form-control input-sm\" type=\"text\" value=\"$Supplier_Email\">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width=\"30%\">Phone</td>
                                                <td><input placeholder='' name = 'Supplier_Phone' class=\"form-control input-sm\" type=\"text\" value=\"$Supplier_Phone\"></td>
                                            </tr>
                                            <tr>
                                                <td width=\"30%\">Alternate Phone</td>
                                                <td><input placeholder='' name = 'Supplier_Alt_Phone' class=\"form-control input-sm\" type=\"text\" value=\"$Supplier_Alt_Phone\"></td>
                                            </tr>
                                            <tr>
                                                <td width=\"30%\">Address</td>
                                                <td><input placeholder='' name = 'Supplier_Address' class=\"form-control input-sm\" type=\"text\" value=\"$Supplier_Address\"></td>
                                            </tr>
                                            <tr>
                                                <td width=\"30%\"></td>
                                                <td><input value='Update Supplier Details' type='submit' name='UpdateSupplierGeneralDetails' class='btn btn-success btn-sm'\></td>
                                                <td></td>
                                            </tr>
