...
<?php 
        ...
        //New Orders
          $sql = "SELECT count(*) as count FROM order_items, products where order_items.Product_ID = products.ID  and products.Supplier_ID='$SupplierID' and order_items.State = '1'";
        ...
        //Ongoing Orders
           $sql = "SELECT count(*) as count FROM order_items, products where order_items.Product_ID = products.ID  and products.Supplier_ID='$SupplierID' and order_items.State = '2'";
          $result = $conn->query($sql);
          if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
        ...
        //Completed Orders
           $sql = "SELECT count(*) as count FROM order_items, products where order_items.Product_ID = products.ID  and products.Supplier_ID='$SupplierID' and order_items.State = '3'";
          $result = $conn->query($sql);
          if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
        ...
        //Cancelled Orders
           $sql = "SELECT count(*) as count FROM order_items, products where order_items.Product_ID = products.ID  and products.Supplier_ID='$SupplierID' and order_items.State = '4'";
          $result = $conn->query($sql);
          if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
