                                   ...
                                   <ul>
                                       ...
                                       <li><a href="#"><i class="ion-android-cart"></i><span class="cart-add">2</span><span class="cart-total">$215.00 <i class="fa fa-angle-down"></i></span></a>
                                           <ul class="cart-dropdown">
                                               ...
                                               <li class="cart-item">
                                                   <div class="cart-img">
                                                       <a href="shopping-cart.html"><img src="assets/img/cart/1.jpg" alt=""></a>
                                                   </div>
                                               ...
                                               <li class="cart-item">
                                                   <div class="cart-img">
                                                       <a href="shopping-cart.html"><img src="assets/img/cart/2.jpg" alt=""></a>
                                                   </div>
                                                   <div class="cart-content">
